...
# Qualified names. Using obscure signatures to avoid overwriting others.

"Base.factorize"
Base.factorize(s::Symbol, t::Symbol) = ()

"Base.factorize{T}"
Base.factorize{T <: AbstractString}(::T) = ()

"Base.LinAlg.norm"
Base.LinAlg.norm(::AbstractString) = ()
